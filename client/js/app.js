...
angular.module('app', ['ionic', 'ion-datetime-picker', 'fancy-select', 'app.controllers', 'app.routes', 'app.directives', 'app.services'])
    .config(function($ionicConfigProvider, $sceDelegateProvider){
        $sceDelegateProvider.resourceUrlWhitelist([ 'self','*://www.youtube.com/**', '*://player.vimeo.com/video/**']);

        // disable ionic scrolling use native scrolling
